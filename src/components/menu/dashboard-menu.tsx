...
import {
  dashboardMenuData,
  sessionStateMenu,
} from "@/src/static-objects/objects/dashboard-menu";
...
export const DashboardMenu = () => {
  ...
  const filteredSessionState = sessionStateMenu.filter(
    (item) => item.isSession === isSession,
  );
  ...
  return (
    <Popover ref={avatarRef} className="relative flex">
