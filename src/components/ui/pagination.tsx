...
interface PaginationProps {
    ...
    rowsPerPage: number;
    currentPage: number;
    handleChangePaginat: (event: React.ChangeEvent<unknown>, value: number, setCurrentPage: (page: number) => void) => void;
    setCurrentPage: (currentPage:number)=>void;
}   

export const PaginationComponent = ({rows, rowsPerPage, currentPage, handleChangePaginat, setCurrentPage} : PaginationProps) =>{
return(
