...
import { NewsArticleSchema, ParsedNewsArticleSchema, newsArticleSchema } from "@/src/schemas/queries/news-feed";
...
export const newsArticleFetch = async (id:number) =>{
    ...
    try{
        ...
        const parsedRow: NewsArticleSchema = newsArticleSchema.parse(response.rows[0])
